 ...
 */
@Embeddable
public class LremapAuthorsPK implements Serializable {
    ...
    public LremapAuthorsPK() {
    }

    public LremapAuthorsPK(String resourceid, String authornumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LremapAuthorsPK)) {
            return false;
        }
        LremapAuthorsPK other = (LremapAuthorsPK) object;
    ...
    public String toString() {
        return "it.cnr.ilc.jlremap.entities.LremapAuthorsPK[ resourceid=" + resourceid + ", authornumber=" + authornumber + " ]";
    }
