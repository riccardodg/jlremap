...
from ods_lremap_resource_keys K ,  START_DB_2014.START_ISLRN A WHERE  A.passcode = K.passcode AND
...
-- K.conf,K.year,K.passcode,K.resid,K.type,K.prodstatus,  
A.ISLRNStatus, A.ISLRNCode
from ods_lremap_resource_norm_keys K ,  START_DB_2014.START_ISLRN A WHERE  A.passcode = K.passcode AND
	A.resourceid = K.resid  ;