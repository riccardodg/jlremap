 ...
 */
/**
removed resourceid where possible 
*/
SET FOREIGN_KEY_CHECKS=0;

--- ODS auth --
REPLACE INTO ods_lremap_resource_keys SELECT 
MD5(concat(CONF,'#',YEAR,'#',PASSCODE,'#',type,'#',name,'#',prodstatus)) as resourceid,
...
MD5(concat(CONF,'#',YEAR,'#',PASSCODE,'#',norm_type,'#',norm_name,'#',norm_prodstatus)) as resourceid,
...
MD5(concat(CONF,'#',YEAR,'#',PASSCODE,'#',type,'#',name,'#',prodstatus)) as resourceid,
MD5(concat(CONF,'#',YEAR,'#',PASSCODE,'#',norm_type,'#',norm_name,'#',norm_prodstatus)) as resource_normid
 FROM lremap_datathon.stage_lremap_resource_keys A;
