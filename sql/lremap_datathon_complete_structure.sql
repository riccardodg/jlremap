...
CREATE TABLE `lremap_resource` (
  ...
  PRIMARY KEY (`resourceid`),
  CONSTRAINT `fk_lremap_resource2subs` FOREIGN KEY (`resourceid`) REFERENCES `lremap_subs` (`resourceid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `lremap_resource_norm` (
  ...
  `doc` text COLLATE utf8_bin,
  PRIMARY KEY (`resourceid`),
  CONSTRAINT `fk_lremap_resourcenorm2subsnorm` FOREIGN KEY (`resourceid`) REFERENCES `lremap_subs_norm` (`resourceid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-08-04 18:13:05
