...
--
-- Host: 127.0.0.1    Database: lremap_datathon
-- ------------------------------------------------------
...
--
-- Table structure for table `ISO_639-3`
--

DROP TABLE IF EXISTS `ISO_639-3`;
...
--
-- Table structure for table `lremap_conference_years_test`
--

DROP TABLE IF EXISTS `lremap_conference_years_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lremap_conference_years_test` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `CONF` varchar(50) COLLATE utf8_bin NOT NULL,
  `YEAR` char(4) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `lremap_resource_ISLRN`
--
...
--
-- Table structure for table `lremap_resource_ISLRN_norm`
--
...
--
-- Table structure for table `lremap_side_table_avail`
--

DROP TABLE IF EXISTS `lremap_side_table_avail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `lremap_side_table_groupedtype`
--

DROP TABLE IF EXISTS `lremap_side_table_groupedtype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `lremap_side_table_modality`
--
...
--
-- Table structure for table `lremap_side_table_status`
--
...
--
-- Table structure for table `lremap_side_table_use`
--
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `temp` (
  `name` mediumtext CHARACTER SET utf8 COLLATE utf8_bin,
  `type` mediumtext CHARACTER SET utf8 COLLATE utf8_bin,
  `lang1` mediumtext CHARACTER SET utf8 COLLATE utf8_bin
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-02-14 16:26:01
