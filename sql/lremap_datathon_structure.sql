...
CREATE TABLE `lremap_resource_lang_norm` (
  ...
  `langother` text COLLATE utf8_bin,
  PRIMARY KEY (`resourceid`),
  CONSTRAINT `fk_lremap_resource_lang_norm_2_rn` FOREIGN KEY (`resourceid`) REFERENCES `lremap_resource_norm` (`resourceid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-07-31 10:47:40
